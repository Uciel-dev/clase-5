...
botonCalcular.onclick = function() {
    ...
    if (salarioAnual > 0) {
        const salarioMensaul = calcularSalarioMensual(salarioAnual);

        document.querySelector('#salario-mensual').value = salarioMensaul;
    } else {
        alert('Su salario tiene que ser mayor a cero');
    }
